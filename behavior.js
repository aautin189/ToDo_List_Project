...
var input = document.getElementById("userInput");	//getting data
...
// GETTER
// size of the to-do that the user input into text box
...
// how we can tack on a new item to our TO-DO list
